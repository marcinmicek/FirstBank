...
public class Account {
    ...
    void getPreviousTransaction() {
        if (previousTransaction > 0) {
            ...
            System.out.println("Wthdrawn: " + Math.abs(previousTransaction));
        } else {
        ...
        do {
            ...
            switch(option) {
                ...
                case 'F':
                    System.out.println("==================================");
                    break;
                // The default case lets the user know that they entered an invalid character and how to enter a valid option
                default:
